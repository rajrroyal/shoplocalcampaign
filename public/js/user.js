...
/* harmony import */ var _utils_toasts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/toasts */ "./resources/js/utils/toasts.js");
...
window.toasts = _utils_toasts__WEBPACK_IMPORTED_MODULE_2__["default"];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timer */ "./resources/js/utils/timer.js");


var toasts = function toasts() {
  return {
    toasts: [],
    init: function init(toastElem) {
      var _this = this;

      // echo server listener
      window.Echo["private"]("user.update.".concat(user_id)).listen('.toast', function (e) {
        _this.addToast(e.toast);
      }); // add new toast listener

      window.addToast = function (toastInfo) {
        return _this.addToast(toastInfo);
        ...
        mutationsList.forEach(function (mutation) {
          mutation.addedNodes.forEach(function (node) {
            if (node.nodeType == 1) {
              ...
              _this.addGestures(toast);
            }
          });
        });
      });
      observer.observe(toastElem, {
        childList: true
      });
    },
    addToast: function addToast(toastInfo) {
      var _this2 = this;

      var toast_id = this.toasts.length; // handle simple toast messages
      ...
      var toast = Object.assign({
        ...
        closeButton: true,
        timeout: 5000
      }, toastInfo); // add timer to pause on mouseover

      toast.timer = new _timer__WEBPACK_IMPORTED_MODULE_0__["default"](function () {
        _this2.removeToast(toast_id);
      }, toast.timeout);
      this.toasts.push(toast);
      return toast_id;
    },
    removeToast: function removeToast(toast_id) {
      this.toasts[toast_id].open = false;
    },
    addGestures: function addGestures(toast) {
      var _this3 = this;

      var toast_id = toast.dataset.toastId;
      var gesture = new TinyGesture(toast, {
        mouseSupport: true
      });
      gesture.on('panmove', function (event) {
        event.stopPropagation();

        _this3.toasts[toast_id].timer.pause();

        if (gesture.touchMoveX > 0) {
          toast.style.transform = "translateX(".concat(gesture.touchMoveX, "px)");
      ...
      gesture.on('panend', function (event) {
        event.stopPropagation();
        var isSwipe = gesture.swipingDirection === 'horizontal' && gesture.touchMoveX > 0;

        if (!isSwipe) {
          _this3.toasts[toast_id].timer.resume();
...
module.exports = __webpack_require__(/*! /Users/dave/Documents/WWWRoot/ShopCity/shop20/resources/js/user.js */"./resources/js/user.js");
