...
use App\Services\Ecwid\EcwidUpdateStoreService;
...
class UpdateEcwidStoreJob implements ShouldQueue
{
    ...
    {
        // Perform updates
        (new EcwidUpdateStoreService())->update($this->store);
        (new EcwidUpdateProductsService())->update($this->store);
