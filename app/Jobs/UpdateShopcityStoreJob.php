...
use App\Services\Shopcity\ShopcityUpdateListingService;
use App\Services\Shopcity\ShopcityUpdateMicroproductService;
...
class UpdateShopcityStoreJob implements ShouldQueue
{
    ...
    {
        // Perform updates
        $listing = (new ShopcityUpdateListingService())->updateListing($this->store);
        (new ShopcityUpdateMicroproductService())->updateProducts($this->store, $listing->microproducts);
