...
return [
     ...
     */
    'disk_name' => env('MEDIA_DISK', 'content'),
     ...
     */
    'path_generator' => App\Media\MediaPathGenerator::class, // Spatie\MediaLibrary\Support\PathGenerator\DefaultPathGenerator::class,
